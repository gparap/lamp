...
<body>
	...
	<header
		...
		<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="../index.php">e-library</a>
		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<form method="POST" action="" enctype="multipart/form-data">
					<input type="hidden" id="id" name="id" value="<?php echo $book_id; ?>">
					...
					<!--image-->
					<input type="hidden" name="image-old" value="<?php echo $book[0]['image']; ?>">
					<div class="mb-3">
						<label for="image" class="form-label">Image</label>
						<input type="file" class="form-control" id="image" name="image"
								value="<?php echo $book[0]['image']?>">
					</div>

					<!--book-->
					<input type="hidden" name="book-old" value="<?php echo $book[0]['file']; ?>">
					<div class="mb-3">
						<label for="book" class="form-label">Book</label>
						<input type="file" class="form-control" id="book" name="book"
								value="<?php echo $book[0]['file']?>">
					</div>
					...
					<div class="mb-3">
						...
						<input type=number class="form-control" id="year" name="year"
								value="<?php echo $book[0]['year']?>">
					</div>

					<!--Update book button-->
					<button type="submit" class="btn btn-dark" name="button-update-book">Update</button>
				</form>
			</main>
		</div>
	</div>
