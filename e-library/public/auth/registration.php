...
<body>
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link active"
						href="../auth/registration.php">Register</a></li>
				</ul>
			</div>
		</div>
	</nav>
				...
				<form action="#" method="post">
					...
					<div class="mb-3">
						<label class="form-label" for="username">Username</label><input
							...
							name="username" data-bs-theme="light">
					</div>
					<div class="mb-3">
						<label class="form-label" for="password">Password</label><input
							class="form-control item" type="password" id="password"
							name="password" data-bs-theme="light">
					</div>
					<div class="mb-3">
	...
	<?php
    require_once '../../src/auth/registration.php';
    
    //register user
    $is_registration_successful = NULL;
    if (isset($_POST['submit'])) {
        $is_registration_successful = register_user($_POST);
