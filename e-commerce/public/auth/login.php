		...
		<div class="container">
			<a class="navbar-brand d-flex align-items-center" href="../index.php"><span
				class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon">
					<img src="../img/logo.png" class="img-fluid rounded-0 shadow-lg"
					alt="">
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				...
				<a class="btn btn-primary shadow" role="button" href="#">Sign up</a>
			</div>
		</div>
	</nav>
		...
		<div class="container">
			<div
				...
				<form class="d-flex justify-content-center flex-wrap flex-lg-nowrap"
					...
					<div class="my-2">
						<a class="btn btn-primary shadow ms-2" type="button">Subscribe </a>
					</div>
				</form>
			</div>
		</div>
