<footer class="bg-primary-gradient">
	<div class="container py-4 py-lg-5">
		<div class="row justify-content-center">
			...
			<div
				...
				<ul class="list-unstyled">
					<li><a href="<?= PUBLIC_URL ?>index.php">Home</a></li>
					<?php
					if (session_status() == PHP_SESSION_NONE){
						session_start();
					}
					if (isset ( $_SESSION ['role'] )) {
						echo '<li><a href="'.PUBLIC_URL.'auth/logout.php">Sign out</a></li>';
					} else {
						echo '<li><a href="' . PUBLIC_URL . 'auth/login.php">Sign in</a></li>';
					}
					?>
			...
			<div
				...
				<div class="fw-bold d-flex align-items-center mb-2">
					...
					</span><span>E-Commerce</span>
				</div>
				<p class="text-muted">Sem eleifend donec molestie, integer quisque
					orci aliquam.</p>
			</div>
		</div>
		<hr>
		<div
			...
			<p class="mb-0">Copyright © 2026 gparap.com</p>
